...
function resolveExtends(config = {}, context = {}) {
	...
	const extended = loadExtends(config, context).reduceRight((r, c) => (0, _lodash.merge)(r, (0, _lodash.omit)(c, 'extends')), e ? { extends: e } : {});
...
function resolveGlobalSilent(id) {
	try {
		const resolveGlobal = (0, _requireUncached2.default)('resolve-global');
